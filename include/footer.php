                    ...
                    <div class="col-lg-3 col-md-6">
                        ...
                        <div class="col-lg-3 col-md-6">
                            ...
                            <div class="position-relative mx-auto" style="max-width: 400px;">
                                <form action="../kidermain/insets/inset_newsletter.php" method="post">
                                    <input class="form-control bg-transparent w-100 py-3 ps-4 pe-5" type="text" placeholder="" name="email">
